...
המקורות העיקריות ששמשתי בהם היו האתרים [JewishGen](jewishgen.org) ו[familysearch.org](familysearch.org), הרשימות של דודה רות (הדודה של האבא שלי), הרשימות של הרב שמריה שור שליט״א, ושיחות עם קרובים שונים. 
