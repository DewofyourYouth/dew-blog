...
{{< img-gallery >}}
{{< image src="manifest.jpeg" caption="S.S. Gerty passenger manifest, 1904" >}}
{{< image src="manifest-detail.png" caption="Detail: Khaim Hersch Saranduk's row in the Gerty manifest" >}}
{{</ img-gallery >}}
...
## The Talne Family: Avrum Saranduk and His Children
...
{{< img-gallery >}}
{{< image src="census-1858.jpg" caption="1858 Talne Revision List — Avrum, Khaim Hersh, and Moshe Yankel Saranduk" >}}
{{< image src="moshe.jpg" caption="Likely Moshe Yankel Saranduk's birth record.">}}
{{</ img-gallery >}}
...
{{< img-gallery >}}
{{< image src="revision.jpg" caption="A page from the Talne Revision Lists" >}}
{{</ img-gallery >}}
...
1. **[Sam Shore](/post/the-80th-yahrtzeit-of-shmariahu-shore)** (Shmariahu, b. 1868)
2. **[William Serin](/post/a-wolf-who-did-not-become-shore)** (Mordechai Ze'ev / Wolf, b. ~1874) — emigrated ~1902, took the name Serin
3. **Tillie Lisagor** (b. 1882)
4. **Rose Grossman** (b. 1883)
5. **Morris Shore** (b. 1886)

{{< img-gallery >}}
{{< image src="hyman-sarah-tombstone.jpeg" caption="Tombstones of Hyman and Sarah Shore, Lincoln Park Cemetery" >}}
{{< image src="wolko-revision-list.png" caption="1897 Talne Revision List — Wolko (William) Saranduk's household" >}}
{{</ img-gallery >}}
...
{{< img-gallery >}}
{{< image src="sam-shore.jpg" caption="Sam Shore (Shmariahu Saranduk)" >}}
{{< image src="tillieShore.png" caption="Tillie (Taube Beresovsky) Shore" >}}
{{</ img-gallery >}}
...
{{< img-gallery >}}
{{< image src="shmarya-tuba-wedding.jpg" caption="Cherkassy Church Book: marriage of Shmaria and Taube, August 1888" >}}
{{< image src="pessi-saranduk.jpg" caption="Cherkassy Church Book: birth of Pessi (Bessie Fishbein), July 1889" >}}
{{< image src="wedding-record.png" caption="Wedding detail - relevant row." >}}
{{< image src="pessi-birth-record.png" caption="Pessy Shore - Hebrew detail." >}}
{{</ img-gallery >}}
{{< img-gallery>}}
{{< image src="papercut.jpg" caption="Papercut by Sam Shore commemorating his parents Hyman and Sarah" >}}
{{< image src="passover-seder.jpeg" caption="Shore family Passover seder. Sam & Tillie with their children and grandchildren." >}}
{{</ img-gallery >}}
...
{{< img-gallery >}}
{{< image src="sam.jpeg" caption="Tombstone of Sam Shore, Lincoln Park Cemetery" >}}
{{< image src="tillie.jpeg" caption="Tombstone of Tillie Shore, Lincoln Park Cemetery" >}}
{{</ img-gallery >}}

---

## Moshe Yankel's Branch: Philip & Netty Shore
...
{{< img-gallery >}}
{{< image src="philip-netty.jpeg" caption="Philip and Netty Shore with family" >}}
{{< image src="clara.jpg" caption="Clara (Irene) Shore Roth, eldest daughter of Philip and Netty" >}}
{{</ img-gallery >}}
...
{{< img-gallery >}}
{{< image src="philip-name-change.jpg" caption="Philip Shore's naturalization index card — name change entry" >}}
{{< image src="philip-name-change-full.png" caption="Philip Shore's naturalization index card — Saranduk name visible" >}}
{{</ img-gallery >}}
